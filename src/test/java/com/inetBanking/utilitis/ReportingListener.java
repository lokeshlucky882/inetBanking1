...
public class ReportingListener extends TestListenerAdapter
{
	...
	public void onStart(ITestContext testContext)
	{
		...
		reporter.config().setTheme(Theme.DARK); //Theme of chart
	}

	public void onTestSuccess(ITestResult tr)
	{
		logger=reports.createTest(tr.getName()); // create new entry in the report
	...
	{
		logger=reports.createTest(tr.getName()); // create new entry in th report
